...
surr_v2 <- make_surrogate_data(d_ccm$v2_obs, method = "random", num_surr = num_surr)
...
#--- plotting---#
# v1 xmap v2
ggplot(aes(x=LibSize, y=`median_v1_xmap_v2`), data=res) + geom_line() + 
...
# v2 xmap v1
ggplot(aes(x=LibSize, y=`median_v2_xmap_v1`), data=res) + geom_line() + 
